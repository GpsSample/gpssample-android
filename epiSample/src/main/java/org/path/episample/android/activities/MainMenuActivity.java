...
public class MainMenuActivity extends Activity implements ODKActivity {
  ...
  private static final int MENU_BACKUP_CENSUS = Menu.FIRST + 8;
  private static final int MENU_RESTORE_CENSUS = Menu.FIRST + 9;
  private static final int MENU_EDIT_CENSUS = Menu.FIRST + 10;
  private static final int MENU_REMOVE_CENSUS = Menu.FIRST + 11;
  ...
  public static final int SURVEY_REQUEST_CODE = 65837;
  public static final int CENSUS_REQUEST_CODE = 27648;

  // values for external intents to resolve conflicts
  /** Survey's package name as declared in the manifest. */
  public static final String SYNC_PACKAGE_NAME = "org.path.sync";
  ...
  private ScreenList currentFragment = ScreenList.MAIN_MENU;
  ...
  public String doAction(
    ...
    if (action.startsWith("org.path.episample")) {
      Class<?> clazz;
      try {
