...
public class PropertiesSingleton {
  ...
  private static synchronized PropertiesSingleton getSingleton(String appName) {
    ...
    if ( gSingleton == null || gAppName == null || !gAppName.equals(appName) ) {
      ...
      try {
        ...
        File f = new File(ODKFileUtils.getEpiSampleFolder());
        if (!f.exists()) {
          f.mkdir();
  ...
  private PropertiesSingleton(String appName) {
    ...
    defaults.setProperty(AdminPreferencesActivity.KEY_COLLECT, "true");
    defaults.setProperty(AdminPreferencesActivity.KEY_SELECT, "true");
    defaults.setProperty(AdminPreferencesActivity.KEY_SEND_RECEIVE, "true");
    defaults.setProperty(AdminPreferencesActivity.KEY_NAVIGATE, "true");
    defaults.setProperty(AdminPreferencesActivity.KEY_BACKUP_CENSUS, "true");
    defaults.setProperty(AdminPreferencesActivity.KEY_RESTORE_CENSUS, "true");
    defaults.setProperty(AdminPreferencesActivity.KEY_SEND_RECEIVE_BLUETOOTH, "true");
    ...
    defaults.setProperty(AdminPreferencesActivity.KEY_INTERVIEWER_NAME, "true");
    defaults.setProperty(AdminPreferencesActivity.KEY_PHONE_NUMBER, "true");
    defaults.setProperty(AdminPreferencesActivity.KEY_DEVICE_NAME, "true");
    
    defaults.setProperty(AdminPreferencesActivity.KEY_MARK_AS_FINALIZED_BY_FRIENDS, "true");
