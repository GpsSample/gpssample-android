...
import org.path.episample.android.logic.AverageAngle;
 ...
 */
public class DirectionProvider implements SensorEventListener, LocationListener {
	 ...
	 *            Application Context
	 */
	public DirectionProvider(Activity activity) {
	 ...
	 *            listener
	 */
	public DirectionProvider(Activity activity, int smoothing,
